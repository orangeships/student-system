...
本项目是一个基于Django+Vue.js的全栈学生财务管理系统，旨在为学生提供个人财务收支管理功能，包括收支记录、预算管理、财务目标设定等核心功能。系统采用前后端分离架构，后端使用Django REST Framework提供API服务，前端使用Vue.js 3构建单页应用。
...
#### 1. 开发环境准备
- ✅ 操作系统环境配置 (Windows/Mac/Linux兼容)
- ✅ Python虚拟环境搭建 (Python 3.8+)
- ✅ Node.js环境配置 (Node.js 18+)
- ✅ SQLite数据库环境准备 (零配置)
- ✅ VS Code开发工具配置 (完整扩展推荐)
